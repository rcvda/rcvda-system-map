(function(){
  ...
  function initMap(container){
    ...
    fetch(src).then(function(r){return r.json();}).then(function(data){ build(container,data,title); })
      .catch(function(e){ container.innerHTML='<p style="padding:1rem;color:#a15c00">Could not load map data.</p>'; });
  }
